...
class RegistroDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { nombre: { required: true, type: () => String }, email: { required: true, type: () => String }, contrasena: { required: true, type: () => String, minLength: 6, maxLength: 20 } };
    }
}
...
__decorate([
    (0, class_validator_1.IsEmail)({}, { message: 'Ingresa un correo' }),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
